...
function EditProfile() {
    ...
    const getUserDetailsById = (id) => {
        ...
        var url = "http://54.88.41.57:8080/user-service/api/v1/vaccination-center/" + id;
        return fetch(url,
            {
                headers: {
...
function updateUserDetails(user) {
    ...
    var url = "http://54.88.41.57:8080/user-service/api/v1/vaccination-center/" + user.centerId;
