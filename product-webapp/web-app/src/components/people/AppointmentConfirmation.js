...
function Confirmation() {
  ...
  function ConfirmAppointment() {
    ...
    if (apt == null || apt === "undefined" || apt.slot == null || apt.slot === "undefined") {
      ...
      fetch('http://54.88.41.57:8080/slot-booking-service/api/v1/slot',
        {
          headers: {
  ...
  function updateStatusAsBooked(slotId) {
    ...
    let url = "http://54.88.41.57:8080/slot-booking-service/api/v1/slot/status/" + slotId + "?status=BOOKEED";
    return fetch(url,
      {
        headers: {
          'Content-Type': 'application/json',
